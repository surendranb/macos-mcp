...
async function main() {
  ...
  try {
    ...
    console.log(`   ❌ Failed to fetch emails: ${(e as Error).message}`);
  }
  console.log();
  ...
  try {
    ...
    if (schedule.length === 0) {
      ...
      schedule.forEach((event: any, idx: number) => {
        console.log(`   [${idx + 1}] ${event.summary} (${event.start} - ${event.end})`);
      });
    }
  } catch (e) {
    console.log(`   ❌ Failed to fetch yesterday's schedule: ${(e as Error).message}`);
  }
  console.log();
  ...
  try {
    ...
    console.log(`   ❌ Failed to create reminder: ${(e as Error).message}`);
  }
  console.log();
  ...
  try {
    ...
    console.log(`   ❌ Failed to trigger Apple Music: ${(e as Error).message}`);
  }
  console.log();
  ...
  try {
    ...
    console.log(`   ❌ Failed to adjust volume: ${(e as Error).message}`);
  }
  console.log();
  ...
  try {
    ...
    console.log(`   ❌ Failed to query Podcasts database: ${(e as Error).message}`);
  }
  console.log();
  ...
  try {
    ...
    console.log(`   ❌ Health check diagnostic error: ${(e as Error).message}`);
  }
